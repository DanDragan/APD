...
class Reduce extends PartialSolution {
	...
	public void combinePartialVectors() {
		...
		while (entries.hasNext()) {
			...
			Main.mapFreqToFile(frequencies, file);
		}
	}
	...
	/*
	 * a 2-a operatie de reduce se va executa doar dupa terminarea tuturor
	 * task-urilor care executa prima operatie de reduce
	 */
	@Override
	public void go() {
		if (!Main.firstIsOver)
